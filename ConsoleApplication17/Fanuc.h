...
/**
 * \brief Class of robot FanucM20iA
...
class FanucM20iA
{
	...
	*/
	...
	/**
	 * \brief Struct accumulate maximum boundary values
	 */
	...
	/**
	* \brief Struct accumulate minimum boundary values
	*/
	...
	*/
	 ...
	 */
	static void socketErrorOnScreen(int& e);
...
public:
	 ...
	 */
	explicit FanucM20iA(const double xMin = 740., const double yMin = -465., const double zMin = 403.,
